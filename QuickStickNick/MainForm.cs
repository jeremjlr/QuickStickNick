...
namespace QuickStickNick
{
    ...
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// Used to turn on/off the app using keyboard shortcuts.
        /// </summary>
        public bool DoWork
        {
            get;
        ...
        //P/Invoke methods used to get infos about the game and to send keyboard inputs
        ...
        /// <summary>
        /// Ingame keyboard shortcuts and class handlers.
        /// </summary>
        ...
        private void GlobalHook_KeyDown(object sender, KeyEventArgs e)
        {
            if (_statusMonitor.GameHasFocus())
            {
                ...
                else if (SurvivalButton.Checked)
                {
                    SurvivalKeyPressHandle(sender, e);
                }
                else if (ProtButton.Checked)
                {
                    ProtKeyPressHandle(sender, e);
                }
                else if (ArmsButton.Checked)
                {
                    ArmsKeyPressHandle(sender, e);
                }
            }
        }

        /// <summary>
        /// This determines how the app should play BM Hunter, what key to press depending on what key was pressed on the keyboard and which BM Hunter auras are detected.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BMKeyPressHandle(object sender, KeyEventArgs e)
        {
        ...
        /// <summary>
        /// This determines how the app should play Survival Hunter, what key to press depending on what key was pressed on the keyboard and which Survival Hunter auras are detected.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SurvivalKeyPressHandle(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.D1 && !e.Control && !e.Shift && DoWork)
            {
                //Pressed key will be ignored and replaced with the desired key in order to trigger the right action
        ...
        /// <summary>
        /// This determines how the app should play Prot Warrior, what key to press depending on what key was pressed on the keyboard and which Prot Warrior auras are detected.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ProtKeyPressHandle(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.D1 && !e.Control && !e.Shift && DoWork)
            {
                //Pressed key will be ignored and replaced with the desired key in order to trigger the right action
        ...
        /// <summary>
        /// This determines how the app should play Arms Warrior, what key to press depending on what key was pressed on the keyboard and which Arms Warrior auras are detected.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ArmsKeyPressHandle(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.D1 && !e.Control && !e.Shift && DoWork)
            {
                //Pressed key will be ignored and replaced with the desired key in order to trigger the right action
